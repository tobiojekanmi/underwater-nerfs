...
Adapated from https://github.com/xueleichen/PSNR-SSIM-UCIQE-UIQM-Python
...
import math
import sys
from skimage import io, color, filters  # type: ignore
import os
import math


def evaluate_restored(a):
    rgb = a
    lab = color.rgb2lab(a)
    ...
    return np.nan_to_num(uiqm), np.nan_to_num(uciqe)
